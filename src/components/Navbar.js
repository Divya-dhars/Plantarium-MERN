        ...
        <ul>
          ...
          <li>
            <div className='dropdown'>
              <Link to='/indoor' className='nav-link' reloadDocument>Indoor Plants</Link>
              <Link to='/outdoor' className='nav-link' reloadDocument>Outdoor Plants</Link>
              <Link to='/office' className='nav-link' reloadDocument>Office Plants</Link>
              <Link to='/hanging' className='nav-link' reloadDocument>Hanging Plants</Link>
            </div>
